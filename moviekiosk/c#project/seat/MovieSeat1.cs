...
namespace c_project.seat
{
    public partial class MovieSeat1 : Form
    {
        ...
        private void makeEndPanel(int PosX)
        {
            ...
            label1.Font = new Font("KoPubWorld돋움체 Bold", 11.25F, FontStyle.Bold, GraphicsUnit.Point, ((byte)(129)));
        ...
        public void makePanel(int PosX, string startTime, string currentSeat, int ttindex)
        {
            ...
            time1.AutoSize = true;
            time1.Font = new Font("KoPubWorld돋움체 Bold", 11.25F, FontStyle.Bold, GraphicsUnit.Point, ((byte)(129)));
            time1.ForeColor = Color.Transparent;
            time1.Location = new Point(5, 15);
            time1.Name = "time1";
            time1.Size = new Size(92, 23);
            time1.TabIndex = 0;
            ...
            seat1.AutoSize = true;
            seat1.Font = new Font("KoPubWorld돋움체 Bold", 11.25F, FontStyle.Bold, GraphicsUnit.Point, ((byte)(129)));
            seat1.ForeColor = Color.Transparent;
            seat1.Location = new Point(30, 35);
            seat1.Name = "seat1";
            seat1.Size = new Size(49, 23);
            seat1.TabIndex = 1;
